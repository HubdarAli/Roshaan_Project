...
const DashboardPage = () => {
  const customStyles = {
    ...
    option: (provided, state) => ({
      ...provided,
      backgroundColor: state.isSelected ? "#4a90e2" : "white", // Selected option background
    ...
    <div className={`dashboard-container bg-${theme}`}>
          ...
          <div className="container mt-3">
            <div className="row justify-content-between align-items-center">
              <div className="col-auto">
                ...
                >
                  <i className="fas fa-car"></i> Add New Transport
                </button>
                <button
                  className="btn btn-outline-primary me-2"
                ...
                >
                  <i className="fas fa-plus"></i> Add Other Resource
                </button>
      ...
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <button
            className={`nav-link ${
              activeTab === "transport" ? "active bg-primary text-white" : ""
            }`}
          ...
          <table className="table table-striped">
            <thead>
              <tr>
                ...
                <th scope="col">work From HomeDays</th>
      ...
      {activeTab === "otherResources" && (
        <>
          <div className="container-fluid mt-5">
            <div className="d-flex justify-content-between">
              <h4 className="text-center text-primary mb-4">Other Resources</h4>
              <div>
                <select
                  className="form-select"
                  value={filterType}
